...
@Component({
  selector: 'app-maquinaria-main',
  templateUrl: './maquinaria-main.component.html',
  styleUrls: ['./maquinaria-main.component.css']
})
export class MaquinariaMainComponent implements OnInit {
  faEye = faEye;
  faPlus = faPlus;
